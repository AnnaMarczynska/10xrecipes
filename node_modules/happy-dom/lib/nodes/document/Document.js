...
export default class Document extends Node {
    ...
    set adoptedStyleSheets(value) {
        if (!Array.isArray(value)) {
            throw new this[PropertySymbol.window].TypeError(`Failed to set the 'adoptedStyleSheets' property on 'Document': The provided value cannot be converted to a sequence.`);
        }
        for (const sheet of value) {
            if (!(sheet instanceof this[PropertySymbol.window].CSSStyleSheet)) {
                throw new this[PropertySymbol.window].TypeError(`Failed to set the 'adoptedStyleSheets' property on 'Document': Failed to convert value to 'CSSStyleSheet'.`);
            }
        }
    ...
    get links() {
        if (!this[PropertySymbol.links]) {
            this[PropertySymbol.links] = new HTMLCollection(PropertySymbol.illegalConstructor, () => (QuerySelector.querySelectorAll(this, 'a[href],area[href]')[PropertySymbol.items]));
        }
