...
- [ ] 4.1 DEPLOYMENT.md is complete and readable
- [ ] 4.2 Setup script exists and is executable
- [ ] 4.3 VALIDATION.md checklist is complete

#### Manual

- [ ] 4.4 Full signup → add favorite → query database flow works end-to-end
- [ ] 4.5 Health endpoint shows database is connected
- [ ] 4.6 Error handling: database down → 503 response
- [ ] 4.7 Documentation is clear and actionable for ops
