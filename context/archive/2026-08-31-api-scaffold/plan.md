...
- [x] 2.1 Add spring-boot-starter-actuator dependency to pom.xml — 3baa412
- [x] 2.2 Configure Actuator properties in application.properties — 3baa412
- [x] 2.3 Create TheMealDBHealthIndicator component — 3baa412
- [x] 2.4 Add springdoc-openapi dependency to pom.xml — 3baa412
- [x] 2.5 Configure Swagger UI properties — 3baa412
- [x] 2.6 Annotate all endpoints with @Operation/@Parameter/@ApiResponse — 3baa412
- [x] 2.7 Create OpenApiConfig bean with metadata — 3baa412
- [x] 2.8 Health endpoint tests verify db and themealdb components — 3baa412
- [x] 2.9 Swagger JSON endpoint (/v3/api-docs) returns valid OpenAPI spec — 3baa412
- [x] 2.10 Clean Maven build and type checking passes — 3baa412
...
- [x] 3.1 Add spring-boot-starter-validation dependency — 27f23f8
- [x] 3.2 Add @NotNull/@NotEmpty annotations to SearchRequest DTO — 27f23f8
- [x] 3.3 Replace manual null checks in RecipeController with @Valid — 27f23f8
- [x] 3.4 Add MethodArgumentNotValidException handler to GlobalExceptionHandler — 27f23f8
- [x] 3.5 Unit tests for validation pass: null/empty inputs trigger 400 errors — 27f23f8
- [x] 3.6 Integration tests for API contract pass: envelope format, error scenarios — 27f23f8
- [x] 3.7 Health check integration tests pass — 27f23f8
- [x] 3.8 Full test suite passes: mvn test — 27f23f8
- [x] 3.9 Code coverage on RecipeController ≥ 80% — 27f23f8
- [x] 3.10 Checkstyle and type checking pass — 27f23f8
