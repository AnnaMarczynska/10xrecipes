...
- Name: seed.spec.ts >> User Signup >> user sees error message on duplicate email
- Location: tests/e2e/seed.spec.ts:37:3
  ...
  - banner [ref=e3]:
    - navigation [ref=e4]:
      - link "Recipe Search" [ref=e6] [cursor=pointer]:
        - /url: /
      - generic [ref=e7]:
        - generic [ref=e8]: user-1788339834230@example.com
