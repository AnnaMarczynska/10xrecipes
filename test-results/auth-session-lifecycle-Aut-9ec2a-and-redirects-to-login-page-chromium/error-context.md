...
- Name: auth-session-lifecycle.spec.ts >> Auth Session Lifecycle >> logout clears token and redirects to login page
- Location: tests/e2e/auth-session-lifecycle.spec.ts:43:3
  ...
  - banner [ref=e3]:
    - navigation [ref=e4]:
      - link "Recipe Search" [ref=e6] [cursor=pointer]:
        - /url: /
      - generic [ref=e7]:
        - generic [ref=e8]: logout-1788339794157@example.com
