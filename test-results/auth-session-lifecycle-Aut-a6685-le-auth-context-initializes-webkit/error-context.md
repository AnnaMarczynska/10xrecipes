...
- Name: auth-session-lifecycle.spec.ts >> Auth Session Lifecycle >> loading state shown while auth context initializes
- Location: tests/e2e/auth-session-lifecycle.spec.ts:111:3
  ...
  - banner [ref=e3]:
    - navigation [ref=e4]:
      - link "Recipe Search" [ref=e6]:
        - /url: /
      - generic [ref=e7]:
        - generic [ref=e8]: session-1788339855565@example.com
