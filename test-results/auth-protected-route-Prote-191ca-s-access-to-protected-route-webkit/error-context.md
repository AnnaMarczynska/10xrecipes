...
- Name: auth-protected-route.spec.ts >> Protected Routes >> logged out user loses access to protected route
- Location: tests/e2e/auth-protected-route.spec.ts:46:3
  ...
  - banner [ref=e3]:
    - navigation [ref=e4]:
      - link "Recipe Search" [ref=e6]:
        - /url: /
      - generic [ref=e7]:
        - generic [ref=e8]: logoutprot-1788339836498@example.com
